...
void letsdraw() {
  ...
  image(basic,10-(((Tx2-Tx1)*2)*j-(Tx2-Tx1))/2, 10-((Ty3-Ty2)*4-(Ty3-Ty2)/2)/2);
  scale(-1, 1);
  image(basic,10-(Tx2-Tx1)*4-(((Tx2-Tx1)*2)*j-(Tx2-Tx1))/2, 10+(Ty3-Ty2)*5-((Ty3-Ty2)*4-(Ty3-Ty2)/2)/2);
  scale(-1, 1);
  image(basic, 10-(((Tx2-Tx1)*2)*j-(Tx2-Tx1))/2, 10+(Ty3-Ty2)*10-((Ty3-Ty2)*4-(Ty3-Ty2)/2)/2);
  scale(-1, 1);
  image(basic,10-(Tx2-Tx1)*4-(((Tx2-Tx1)*2)*j-(Tx2-Tx1))/2,10+(Ty3-Ty2)*15-((Ty3-Ty2)*4-(Ty3-Ty2)/2)/2);
  resetMatrix();
}
class Bigline {
  /*太い模様一列分の処理
