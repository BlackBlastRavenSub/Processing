...
vertica:
  ...
  y=0;
  for (; i<number_x; i++) {
    Color[i][0]=Color[i][0]+40;
    Color[i][1]=Color[i][1]+80;
    Color[i][2]=Color[i][2]+120;
    if(Color[i][0]>256){Color[i][0]=Color[i][0]-256;}
    if(Color[i][1]>256){Color[i][1]=Color[i][1]-256;}
    if(Color[i][2]>256){Color[i][2]=Color[i][2]-256;}
  }
  i=0;
}